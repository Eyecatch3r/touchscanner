...
export const products: productData[] = [
  ...
  },
  {
    ...
    shopName: 'SHEIN',
    distance: 8,
    description: 'Farbe: Weiss, Stil: Elegant, Details: Durchsichtige Spitze, Material: Polyester, Größe: S, M, L',
    keywords: ['Kleid', 'Dress', 'White', 'Weiß', 'Weiss', 'Abschluss'],
    isFeatured: false,
  },
  {
    id: 16,
  ...
  },
  {
    ...
    shopName: 'Cyberport',
    distance: 3,
    description: 'KOMPROMISSLOS LEISE UND PERFORMANT Silent Wings 4 Lüfter sind der Inbegriff von high-performance Lüftern mit erstklassigen Features. Technisch bis ins Detail optimiert eignen sich Silent Wings 4 Lüfter für Radiatoren, auf Kühlkörpern und als Gehäuselüfter in high-end PC-Builds gleichermaßen.',
